    ...
    return (
        <>
            ...
            <div className="overflow-x-hidden bg-gray-50 dark:bg-gray-900">
                <header
                    className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 text-gray-950 dark:text-white md:mx-auto md:flex-row md:items-center">
                ...
                <div className="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center">
                            <h1 className="mt-5 text-3xl font-light leading-snug text-gray-900 dark:text-gray-50 sm:text-5xl sm:leading-snug lg:text-6xl lg:leading-snug">
                                Monetize <br className="sm:hidden"/>
                                your community
                                <span className="relative inline-flex justify-center whitespace-nowrap font-bold">
            <svg className="absolute -bottom-8 hidden w-2/3 text-amber-900 sm:block" viewBox="0 0 490 42" fill="none"
            ...
            with Web3 payment</span
                            ...
                            <p className="mx-auto mt-10 max-w-md text-base leading-7 text-gray-600">Lorem ipsum dolor sit
                                amet consectetur adipisicing elit. Eius deleniti perferendis magnam.</p>

                            <div className="group relative mt-10 max-w-lg mx-auto">
                                <form>
                                    <label htmlFor="search"
                                           className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                                    <div className="relative">
                                        <div
                                            className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none font-bold">
                                            bloak.io/
                                        </div>
                    ...
                    <div
                        ...
                        <div className="flex max-w-xs space-x-2 px-4 py-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-amber-900" fill="none"
